...
import curso.udemy.NativeToast;
...
public class FloatingModMenuService extends Service {
    //********** Aqui você pode alterar facilmente a aparência do menu **********//
    ...
    //inicializa métodos da biblioteca nativa
    ...
    //Quando esta classe é chamada o código nesta função será executado
    @Override
    public void onCreate() {
        ...
        LoadSounds(cacheDir);
        //Uma pequena mensagem para o usuário quando ele abre o aplicativo
        ...
        //Cria um handler para esta classe
    ...
    //Aqui nós escrevemos o código para o nosso Menu
    // Reference: https://www.androidhive.info/2016/11/android-floating-widget-like-facebook-chat-head/
    private void initFloating() {
        rootFrame = new FrameLayout(this); // Global markup
        rootFrame.setOnTouchListener(onTouchListener());
        mRootContainer = new RelativeLayout(this); // Marcação na qual serão colocadas duas marcações do ícone e do próprio menu
        mCollapsed = new RelativeLayout(this); // Marcação do ícone (quando o menu está minimizado)
        mCollapsed.setVisibility(View.VISIBLE);
        mCollapsed.setAlpha(ICON_ALPHA);

        //********** A caixa do mod menu **********
        mExpanded = new LinearLayout(this); // Marcação do menu (quando o menu é expandido)
